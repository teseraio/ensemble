...
func resourcesMockTemplate() (*asset, error) {
	...
	info := bindataFileInfo{name: "resources/mock.template", size: 250, mode: os.FileMode(436), modTime: time.Unix(1626873584, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func resourcesSrvClusterRoleJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "resources/srv-cluster-role.json", size: 1257, mode: os.FileMode(436), modTime: time.Unix(1626853810, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
