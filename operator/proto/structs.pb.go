...
func (x *InstanceUpdate) GetConfigured() *InstanceUpdate_Configured {
	if x, ok := x.GetEvent().(*InstanceUpdate_Configured_); ok {
		return x.Configured
	}
	return nil
}
...
type InstanceUpdate_Configured_ struct {
	Configured *InstanceUpdate_Configured `protobuf:"bytes,8,opt,name=configured,proto3,oneof"`
}
...
func (*InstanceUpdate_Configured_) isInstanceUpdate_Event() {}
...
type InstanceUpdate_Configured struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *InstanceUpdate_Configured) Reset() {
	*x = InstanceUpdate_Configured{}
	if protoimpl.UnsafeEnabled {
...
func (x *InstanceUpdate_Configured) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InstanceUpdate_Configured) ProtoMessage() {}

func (x *InstanceUpdate_Configured) ProtoReflect() protoreflect.Message {
	mi := &file_operator_proto_structs_proto_msgTypes[27]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InstanceUpdate_Configured.ProtoReflect.Descriptor instead.
func (*InstanceUpdate_Configured) Descriptor() ([]byte, []int) {
	return file_operator_proto_structs_proto_rawDescGZIP(), []int{9, 5}
}
...
var file_operator_proto_structs_proto_rawDesc = []byte{
	...
	0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x22, 0xe2, 0x01, 0x0a, 0x08, 0x4e, 0x6f, 0x64, 0x65, 0x53, 0x70,
	...
	0x69, 0x6c, 0x65, 0x52, 0x05, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x12, 0x10, 0x0a, 0x03, 0x63, 0x6d,
	...
	0x22, 0xa9, 0x04, 0x0a, 0x0e, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x55, 0x70, 0x64,
	...
	0x6c, 0x74, 0x68, 0x79, 0x48, 0x00, 0x52, 0x07, 0x68, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x79, 0x12,
	0x42, 0x0a, 0x0a, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75, 0x72, 0x65, 0x64, 0x18, 0x08, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x49, 0x6e, 0x73, 0x74,
	0x61, 0x6e, 0x63, 0x65, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x2e, 0x43, 0x6f, 0x6e, 0x66, 0x69,
	0x67, 0x75, 0x72, 0x65, 0x64, 0x48, 0x00, 0x52, 0x0a, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75,
	0x72, 0x65, 0x64, 0x1a, 0x09, 0x0a, 0x07, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x79, 0x1a, 0x0b,
	...
	0x6e, 0x64, 0x6c, 0x65, 0x72, 0x1a, 0x0c, 0x0a, 0x0a, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75,
	0x72, 0x65, 0x64, 0x42, 0x07, 0x0a, 0x05, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x22, 0xdc, 0x01, 0x0a,
...
var file_operator_proto_structs_proto_goTypes = []interface{}{
	...
	(*InstanceUpdate_Configured)(nil), // 32: proto.InstanceUpdate.Configured
	...
	nil,                               // 36: proto.Event.DetailsEntry
...
var file_operator_proto_structs_proto_depIdxs = []int32{
	...
	37, // 1: proto.Component.spec:type_name -> google.protobuf.Any
	0,  // 2: proto.Component.status:type_name -> proto.Component.Status
	1,  // 3: proto.Component.action:type_name -> proto.Component.Action
	38, // 4: proto.Component.Timestamp:type_name -> google.protobuf.Timestamp
	...
	32, // 19: proto.InstanceUpdate.configured:type_name -> proto.InstanceUpdate.Configured
	9,  // 20: proto.Plan.cluster:type_name -> proto.ClusterSpec
	13, // 21: proto.Plan.deployment:type_name -> proto.Deployment
	16, // 22: proto.Plan.nodeUpdate:type_name -> proto.Instance
	20, // 23: proto.Instance.group:type_name -> proto.ClusterSpec.Group
	33, // 24: proto.Instance.KV:type_name -> proto.Instance.KVEntry
	12, // 25: proto.Instance.spec:type_name -> proto.NodeSpec
	2,  // 26: proto.Instance.status:type_name -> proto.Instance.Status
	34, // 27: proto.Instance.reschedule:type_name -> proto.Instance.Reschedule
	35, // 28: proto.Instance.mounts:type_name -> proto.Instance.Mount
	...
	36, // 31: proto.Event.details:type_name -> proto.Event.DetailsEntry
	38, // 32: proto.Event.timestamp:type_name -> google.protobuf.Timestamp
	11, // 33: proto.ClusterSpec.Group.params:type_name -> proto.Spec
	11, // 34: proto.ClusterSpec.Group.resources:type_name -> proto.Spec
	11, // 35: proto.ClusterSpec.Group.storage:type_name -> proto.Spec
	24, // 36: proto.Spec.Block.attrs:type_name -> proto.Spec.Block.AttrsEntry
	11, // 37: proto.Spec.Array.values:type_name -> proto.Spec
	11, // 38: proto.Spec.Block.AttrsEntry.value:type_name -> proto.Spec
	8,  // 39: proto.EnsembleService.Apply:input_type -> proto.Component
	39, // 40: proto.EnsembleService.ListDeployments:input_type -> google.protobuf.Empty
	6,  // 41: proto.EnsembleService.GetDeployment:input_type -> proto.GetDeploymentReq
	8,  // 42: proto.EnsembleService.Apply:output_type -> proto.Component
	5,  // 43: proto.EnsembleService.ListDeployments:output_type -> proto.ListDeploymentsResp
	13, // 44: proto.EnsembleService.GetDeployment:output_type -> proto.Deployment
...
func file_operator_proto_structs_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_operator_proto_structs_proto_msgTypes[27].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*InstanceUpdate_Configured); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_operator_proto_structs_proto_msgTypes[9].OneofWrappers = []interface{}{
		...
		(*InstanceUpdate_Configured_)(nil),
	}
	type x struct{}
