...
var file_operator_proto_structs_proto_rawDesc = []byte{
	...
	0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x73, 0x22, 0x9f, 0x02, 0x0a, 0x08, 0x49, 0x6e,
	...
	0x73, 0x70, 0x65, 0x63, 0x1a, 0x35, 0x0a, 0x07, 0x4b, 0x56, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12,
	0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65,
	0x79, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xd2, 0x02, 0x0a, 0x0a,
	...
	0x43, 0x45, 0x4c, 0x4c, 0x45, 0x44, 0x10, 0x03, 0x22, 0x26, 0x0a, 0x07, 0x54, 0x72, 0x69, 0x67,
...
var file_operator_proto_structs_proto_goTypes = []interface{}{
	...
	(*Group_Mount)(nil),               // 24: proto.Group.Mount
	nil,                               // 25: proto.NodeSpec.EnvEntry
	nil,                               // 26: proto.NodeSpec.FilesEntry
	(*Plan_Step)(nil),                 // 27: proto.Plan.Step
	(*Plan_Step_ActionDelete)(nil),    // 28: proto.Plan.Step.ActionDelete
	(*Plan_Step_ActionScaleUp)(nil),   // 29: proto.Plan.Step.ActionScaleUp
	(*Plan_Step_ActionScaleDown)(nil), // 30: proto.Plan.Step.ActionScaleDown
...
var file_operator_proto_structs_proto_depIdxs = []int32{
	7,  // 0: proto.ComponentTask.old:type_name -> proto.Component
	7,  // 1: proto.ComponentTask.new:type_name -> proto.Component
	...
	12, // 8: proto.Cluster.groups:type_name -> proto.Group
	2,  // 9: proto.Cluster.status:type_name -> proto.Cluster.Status
	3,  // 10: proto.Group.status:type_name -> proto.Group.Status
	33, // 11: proto.Group.resources:type_name -> google.protobuf.Any
	33, // 12: proto.Group.config:type_name -> google.protobuf.Any
	24, // 13: proto.Group.mounts:type_name -> proto.Group.Mount
	25, // 14: proto.NodeSpec.env:type_name -> proto.NodeSpec.EnvEntry
	26, // 15: proto.NodeSpec.files:type_name -> proto.NodeSpec.FilesEntry
	15, // 16: proto.Context.plan:type_name -> proto.Plan
	11, // 17: proto.Context.cluster:type_name -> proto.Cluster
	27, // 18: proto.Plan.steps:type_name -> proto.Plan.Step
	17, // 19: proto.Deployment.instances:type_name -> proto.Instance
	31, // 20: proto.Instance.KV:type_name -> proto.Instance.KVEntry
	13, // 21: proto.Instance.spec:type_name -> proto.NodeSpec
	4,  // 22: proto.Evaluation.status:type_name -> proto.Evaluation.Status
	5,  // 23: proto.Evaluation.triggeredBy:type_name -> proto.Evaluation.Trigger
	15, // 24: proto.Evaluation.plan:type_name -> proto.Plan
	32, // 25: proto.Event.details:type_name -> proto.Event.DetailsEntry
	34, // 26: proto.Event.timestamp:type_name -> google.protobuf.Timestamp
	22, // 27: proto.ClusterSpec.Set.config:type_name -> proto.ClusterSpec.Set.ConfigEntry
	23, // 28: proto.ClusterSpec.Set.resources:type_name -> proto.ClusterSpec.Set.ResourcesEntry
	28, // 29: proto.Plan.Step.actionDelete:type_name -> proto.Plan.Step.ActionDelete
	29, // 30: proto.Plan.Step.actionScaleUp:type_name -> proto.Plan.Step.ActionScaleUp
	30, // 31: proto.Plan.Step.actionScaleDown:type_name -> proto.Plan.Step.ActionScaleDown
	7,  // 32: proto.EnsembleService.Apply:input_type -> proto.Component
	7,  // 33: proto.EnsembleService.Apply:output_type -> proto.Component
