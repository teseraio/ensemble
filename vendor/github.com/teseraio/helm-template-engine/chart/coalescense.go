...
func CoalesceValues(chrt *Chart, vals map[string]interface{}) (Values, error) {
...
func coalesce(ch *Chart, dest map[string]interface{}) (map[string]interface{}, error) {
	coalesceValues(ch, dest)
	return coalesceDeps(ch, dest)
}

// coalesceDeps coalesces the dependencies of the given chart.
func coalesceDeps(chrt *Chart, dest map[string]interface{}) (map[string]interface{}, error) {
...
func coalesceValues(c *Chart, v map[string]interface{}) {
