...
func (e Engine) Render(chrt *chart.Chart, values chart.Values) (map[string]string, error) {
...
func Render(chrt *chart.Chart, values chart.Values) (map[string]string, error) {
...
func (e Engine) initFunMap(t *template.Template, referenceTpls map[string]renderable) {
	...
	funcMap["tpl"] = func(tpl string, vals chart.Values) (string, error) {
...
func (e Engine) renderWithReferences(tpls, referenceTpls map[string]renderable) (rendered map[string]string, err error) {
	...
	for _, filename := range keys {
		...
		vals["Template"] = chart.Values{"Name": filename, "BasePath": tpls[filename].basePath}
		var buf strings.Builder
...
func allTemplates(c *chart.Chart, vals chart.Values) map[string]renderable {
...
// scope.
func recAllTpls(c *chart.Chart, templates map[string]renderable, vals chart.Values) {
	next := map[string]interface{}{
		"Chart":        c.Metadata,
		"Files":        newFiles(c.Files),
		"Release":      vals["Release"],
		"Capabilities": vals["Capabilities"],
		"Values":       make(chart.Values),
	}
